...
/**
 * JAX-RS request filter responsible for retrieving request data and logging for an \@Audited
 * resource
 *
 * @author craiskin
 */
...
public class RequestAuditLogFilter implements ContainerRequestFilter {
  ...
  public void filter(ContainerRequestContext requestContext) throws IOException {
    ...
    builder.append(System.lineSeparator()).append("AUDITED RESOURCE")
    ...
    builder.append("  Method   : ").append(requestContext.getMethod())
        .append(System.lineSeparator());
    builder.append("  URI      : ").append(requestContext.getUriInfo().getRequestUri())
        .append(System.lineSeparator());
    for (Map.Entry<String, List<String>> entry : requestContext.getUriInfo()
        .getQueryParameters(true).entrySet()) {
      final String name = entry.getKey();
      final List<String> value = entry.getValue();
      builder.append("  Param    : ").append(name).append(" = ").append(value)
          .append(System.lineSeparator());
    }
